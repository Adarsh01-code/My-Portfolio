...
const About = () => {
  return (
    ...
    Hello I'm <span className="blue-gradient_text font-semibold drop-shadow">Adarsh</span>
    ...
    {experiences.map((experience) => (
      ...
      >
      <div> <h3 className='text-black text-xl font-poppins font-semibold'> {experience.title} </h3> 
